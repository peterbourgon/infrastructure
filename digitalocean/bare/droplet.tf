...
resource "digitalocean_droplet" "droplet" {
	...
	provisioner "remote-exec" {
		inline = [
			...
			# Go
			"wget https://storage.googleapis.com/golang/go1.8beta2.linux-amd64.tar.gz",
			"tar -C /usr/local -xzf go1.8beta2.linux-amd64.tar.gz",
			"rm go1.8beta2.linux-amd64.tar.gz",
